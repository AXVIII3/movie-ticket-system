...
public class TotalCostDialog extends JDialog
{
    public TotalCostDialog(Window window, int[] ticketsPerSection, int[] costData)
    {
        ...
        L.setOpaque(false);
        L.setLayout(layout);
        billPanel.add(L, new GridBagSettings(0, 0, 1, 1,
                GridBagSettings.BOTH, new Insets(0, 0, 0, 2)));
        billPanel.add(R, new GridBagSettings(1, 0, 0, 1,
                GridBagSettings.BOTH, new Insets(0, 2, 0, 0)));
        ...
        L.add(perRowCostPanelL, new GridBagSettings(0, 0, 1, 1, GridBagSettings.BOTH,
                new Insets(0, 0, 2, 0)));
        L.add(taxesAndFeesPanelL, new GridBagSettings(0, 1, 1, 1, GridBagSettings.BOTH,
                new Insets(2, 0, 0, 0)));

        R.add(perRowCostPanelR, new GridBagSettings(0, 0, 1, 1, GridBagSettings.BOTH,
                new Insets(0, 0, 2, 0)));
        R.add(taxesAndFeesPanelR, new GridBagSettings(0, 1, 1, 1, GridBagSettings.BOTH,
                new Insets(2, 0, 0, 0)));
        ...
        perRowCostPanelL.add(new Label(
                "   Front Row Seats (" + ticketsPerSection[0] + "x)",
                Visuals.Colors.TEXT_NORMAL,
                Visuals.Fonts.NORMAL_FONT)
        );
        perRowCostPanelL.add(new Label(
                "   Normal Row Seats (" + ticketsPerSection[1] + "x)",
                Visuals.Colors.TEXT_NORMAL,
                Visuals.Fonts.NORMAL_FONT)
        );
        perRowCostPanelL.add(new Label(
                "   Premium Row Seats (" + ticketsPerSection[2] + "x)",
                Visuals.Colors.TEXT_NORMAL,
                Visuals.Fonts.NORMAL_FONT)
        );
        perRowCostPanelL.add(new Label(
        ...
        perRowCostPanelR.add(new Label(
                "   Rs." + costData[0] + "   ",
                Visuals.Colors.TEXT_NORMAL,
                Visuals.Fonts.NORMAL_FONT)
        );
        ...
        taxesAndFeesPanelL.add(new Label(
                "   CGST (" + BookingManager.CGST_PERCENTAGE + "%)",
                Visuals.Colors.TEXT_NORMAL,
                Visuals.Fonts.NORMAL_FONT)
        );
        taxesAndFeesPanelL.add(new Label(
                "   SGST (" + BookingManager.SGST_PERCENTAGE + "%)",
                Visuals.Colors.TEXT_NORMAL,
                Visuals.Fonts.NORMAL_FONT)
        );
        taxesAndFeesPanelL.add(new Label(
                "   Convenience Fee (" + BookingManager.CONVENIENCE_FEE_PERCENTAGE + "%)",
                Visuals.Colors.TEXT_NORMAL,
                Visuals.Fonts.NORMAL_FONT)
        );

        taxesAndFeesPanelR.add(new Label(
                "   Rs." + costData[4] + "   ",
                Visuals.Colors.TEXT_NORMAL,
                Visuals.Fonts.NORMAL_FONT)
        );
        ...
        finalCostPanel.add(new Label(
                "Total Cost: Rs." + costData[7],
                Visuals.Colors.TEXT_NORMAL,
                Visuals.Fonts.NORMAL_FONT)
        );

        add(mainLabel, new GridBagSettings(0, 0, 1, 0, GridBagSettings.HORIZONTAL,
                new Insets(10, 15, 0 ,15)));
        add(billPanel, new GridBagSettings(0, 1, 1, 1, GridBagSettings.BOTH,
                new Insets(15, 15, 0 ,15)));
        add(finalCostPanel, new GridBagSettings(0, 2, 1, 0, GridBagSettings.HORIZONTAL,
                new Insets(4, 15, 10 ,15)));
        add(buttonsPanel, new GridBagSettings(0, 3, 1, 0, GridBagSettings.HORIZONTAL,
