...
public class PreviousBookingsScreen extends Screen
{
    ...
    public PreviousBookingsScreen()
    {
        ...
        GridBagSettings bookingsPanelConstraints = new GridBagSettings(0, 1, 1, 1,
        ...
        returnButton.addActionListener(e ->
                ((GUI.Window) SwingUtilities.getWindowAncestor(this)).openScreen("Main")
        );
    ...
    public void PopulateBookings(Account account)
    {
        ...
        {
            bookingsPanel.add(new Label(
                    "Feels a bit empty around here! Wanna book a movie?",
                    Visuals.Colors.TEXT_NORMAL,
        ...
        for (Booking booking : account.previousBookings)
        {
            ...
            Label dataLabel = new Label(
                    ...
                    Visuals.Colors.TEXT_NORMAL,
                    Visuals.Fonts.SMALL_FONT
            );
            dataLabel.setHorizontalAlignment(Label.CENTER);
            holder.add(dataLabel, new GridBagSettings(0, 1, 1, 0, GridBagSettings.HORIZONTAL,
                new Insets(0, 4, 4, 4)));
            Label seatsLabel = new Label(
                    "Seats: " + booking.seatsStr,
                    Visuals.Colors.TEXT_NORMAL,
                    Visuals.Fonts.SMALLER_FONT
            );
            seatsLabel.setHorizontalAlignment(Label.CENTER);
            holder.add(seatsLabel, new GridBagSettings(0, 2, 1, 0, GridBagSettings.HORIZONTAL,
                new Insets(0, 4, 6, 4)));
            Button cancelButton = new Button("Cancel", new Dimension(200, 30));
            holder.add(cancelButton, new GridBagSettings(0, 3, 1, 0, GridBagSettings.HORIZONTAL,
                    ))
